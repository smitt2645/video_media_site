...
const SideBar = () => {
  ...
  return (
    <div>
        <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-white border-r transition-all duration-300 overflow-y-auto`}>
        <div className="p-4">
          {/* Main Navigation */}
          ...
          {sidebarOpen && (
            <>
              ...
              <div className="mt-6 pt-6 border-t">
                <h3 className="px-3 mb-2 text-sm font-semibold text-gray-600">Library</h3>
                <div className="space-y-1">
              ...
              {/* Explore Section */}
              <div className="mt-6 pt-6 border-t">
                <h3 className="px-3 mb-2 text-sm font-semibold text-gray-600">Explore</h3>
                <div className="space-y-1">
                  {exploreItems.map((item, idx) => (
                    <button
                      key={idx}
                      className="w-full flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors"
                    >
                      <item.icon className="w-5 h-5" />
                      <span>{item.label}</span>
                    </button>
              ...
              <div className="mt-6 pt-6 border-t">
                <div className="space-y-1">
                  <button className="w-full flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors">
