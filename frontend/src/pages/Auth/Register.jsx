...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("http://localhost:8002/api/v1/user/register",{firstName:formData.firstName,lastName:formData.lastName,username:formData.username,email:formData.email,password:formData.password},{withCredentials:true})
